      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <Link to="/" className="block font-medium text-lg" aria-label="Zepher.io">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link to="/contact" className="text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">
                  Contact
                </Link>
              </li>
              <li>
                <Link target={'_blank'} to="https://docs.zepher.io" className="text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">docs.zepher.io
              ...
              {/* <Dropdown title="Resources">
                <li>
                  <Link to="/documentation" className="font-medium text-sm text-gray-600 hover:text-gray-900 flex py-2 px-5 leading-tight">docs.zepher.io</Link>
                </li>
                <li>
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link target={'_blank'} to="https://dash.zepher.io" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">dash.zepher.io
                  <svg className="w-3 h-3 fill-current text-gray-400 shrink-0 ml-2 -mr-1" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.707 5.293L7 .586 5.586 2l3 3H0v2h8.586l-3 3L7 11.414l4.707-4.707a1 1 0 000-1.414z" fillRule="nonzero" />
                  </svg>
                </Link>
